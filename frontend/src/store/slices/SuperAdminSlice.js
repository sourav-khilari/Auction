...
export const getMonthlyRevenue = () => async (dispatch) => {
    ...
    try {
        ...
        dispatch(superAdminSlice.actions.successForMonthlyRevenue(response.data.totalMonthRevenue));
...
export const getAllPaymentProofs = () => async (dispatch) => {
    ...
    try {
        ...
        dispatch(superAdminSlice.actions.successForPaymentProof(response.data.paymentProofs));
...
export const deletePaymentProof = (id) => async (dispatch) => {
    ...
    try {
        const response = await axios.delete(`http://localhost:5000/api/v1/superadmin/paymentproofs/delete/${id}`, { withCredentials: true })
...
export const updatePaymentProof = (id, status, amount) => async (dispatch) => {
    ...
    try {
        const response = await axios.put(`http://localhost:5000/api/v1/superadmin/paymentproofs/status/update/${id}`,
            { status, amount },
            {
...
export const deleteAuctionItem = (id) => async (dispatch) => {
    ...
    try {
        const response = await axios.delete(`http://localhost:5000/api/v1/superadmin/auctionitem/delete/${id}`, {
            withCredentials: true,
        });
